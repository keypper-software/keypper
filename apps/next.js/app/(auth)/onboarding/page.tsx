...
export default () => {
  ...
  return (
    <div className="p-10 bg-black-bg h-screen">
      ...
      <Card className="flex flex-col gap-4 relative items-center mt-10 max-w-lg mx-auto border-white/5">
        <div className="absolute pointer-events-none inset-0 opacity-50 bg-gradient-to-br from-green-900/5 to-accent/5"></div>
